...
const siteUrlFix_1 = require("./siteUrlFix");
const addSiteComposer_1 = __importDefault(require("./addSiteComposer"));
const phpSync_1 = __importDefault(require("./phpSync"));
function default_1(context) {
    const { siteData, localLogger, wpCli, lightningServices, configTemplates, siteDatabase } = LocalMain.getServiceContainer().cradle;
     ...
     */
    (0, siteUrlFix_1.applySiteUrlQueryPatch)({ siteDatabase, logger });
}
